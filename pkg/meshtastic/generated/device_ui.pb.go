...
var file_meshtastic_device_ui_proto_rawDesc = []byte{
	...
	0x10, 0x02, 0x2a, 0xb4, 0x02, 0x0a, 0x08, 0x4c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x12,
	...
	0x05, 0x43, 0x5a, 0x45, 0x43, 0x48, 0x10, 0x12, 0x12, 0x16, 0x0a, 0x12, 0x53, 0x49, 0x4d, 0x50,
	0x4c, 0x49, 0x46, 0x49, 0x45, 0x44, 0x5f, 0x43, 0x48, 0x49, 0x4e, 0x45, 0x53, 0x45, 0x10, 0x1e,
	0x12, 0x17, 0x0a, 0x13, 0x54, 0x52, 0x41, 0x44, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0x41, 0x4c, 0x5f,
	0x43, 0x48, 0x49, 0x4e, 0x45, 0x53, 0x45, 0x10, 0x1f, 0x42, 0x63, 0x0a, 0x13, 0x63, 0x6f, 0x6d,
	0x2e, 0x67, 0x65, 0x65, 0x6b, 0x73, 0x76, 0x69, 0x6c, 0x6c, 0x65, 0x2e, 0x6d, 0x65, 0x73, 0x68,
	0x42, 0x0e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x55, 0x49, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x73,
...
var (
	...
	file_meshtastic_device_ui_proto_rawDescData = file_meshtastic_device_ui_proto_rawDesc
)

func file_meshtastic_device_ui_proto_rawDescGZIP() []byte {
	file_meshtastic_device_ui_proto_rawDescOnce.Do(func() {
		file_meshtastic_device_ui_proto_rawDescData = protoimpl.X.CompressGZIP(file_meshtastic_device_ui_proto_rawDescData)
	})
...
var file_meshtastic_device_ui_proto_goTypes = []interface{}{
...
func file_meshtastic_device_ui_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_meshtastic_device_ui_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_meshtastic_device_ui_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_meshtastic_device_ui_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_meshtastic_device_ui_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_meshtastic_device_ui_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Map); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_meshtastic_device_ui_proto_rawDesc,
			NumEnums:      4,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_meshtastic_device_ui_proto_rawDesc = nil
